...
precompile(Tuple{Pkg.PlatformEngines.var"##download_verify_unpack#25", Nothing, Bool, Bool, Bool, Bool, Base.TTY, typeof(Pkg.PlatformEngines.download_verify_unpack), String, Nothing, String})
...
precompile(Tuple{typeof(Base.display_error), Base.TTY, BoundsError, Array{Union{Ptr{Nothing}, Base.InterpreterIP}, 1}})
precompile(Tuple{Base.var"#printstyled##kw", NamedTuple{(:bold, :color), Tuple{Bool, Symbol}}, typeof(Base.printstyled), Base.TTY, String})
precompile(Tuple{typeof(Base.summary), Base.IOContext{Base.TTY}, Array{Base.SubString{String}, 1}})
