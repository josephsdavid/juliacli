...
precompile(Tuple{typeof(Base.setproperty!), Pkg.MiniProgressBars.MiniProgressBar, Symbol, UInt32})
precompile(Tuple{typeof(Pkg.MiniProgressBars.show_progress), Base.TTY, Pkg.MiniProgressBars.MiniProgressBar})
precompile(Tuple{typeof(Base.setproperty!), Pkg.MiniProgressBars.MiniProgressBar, Symbol, String})
