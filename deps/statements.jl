...
precompile(Tuple{typeof(StaticLint.bindingof), String})
...
precompile(Tuple{typeof(LanguageServer.resolve_shadow_binding), SymbolServer.FunctionStore})
...
precompile(Tuple{typeof(LanguageServer.get_hover), SymbolServer.ModuleStore, String, LanguageServer.LanguageServerInstance})
precompile(Tuple{typeof(Base.print), Base.GenericIOBuffer{Array{UInt8, 1}}, SymbolServer.ModuleStore})
precompile(Tuple{CSTParser.var"#parse_blockexpr##kw", NamedTuple{(:allow_const_field,), Tuple{Bool}}, typeof(CSTParser.parse_blockexpr), CSTParser.ParseState, Symbol})
precompile(Tuple{Type{NamedTuple{(:allow_const_field,), T} where T<:Tuple}, Tuple{Bool}})
precompile(Tuple{typeof(Base.haskey), NamedTuple{(:allow_const_field,), Tuple{Bool}}, Symbol})
precompile(Tuple{typeof(CSTParser.parse_mutable), CSTParser.ParseState})
precompile(Tuple{typeof(Base.:(==)), Base.Dict{Symbol, SymbolServer.ModuleStore}, Base.Dict{Symbol, SymbolServer.ModuleStore}})
precompile(Tuple{typeof(Base.:(==)), StaticLint.Scope, Base.Dict{Symbol, SymbolServer.ModuleStore}})
precompile(Tuple{typeof(StaticLint._get_field), StaticLint.Scope, CSTParser.EXPR, StaticLint.Toplevel{LanguageServer.Document}})
...
precompile(Tuple{Base.var"#97#98"{Base.Fix2{typeof(Base.in), Base.Set{Any}}}, SymbolServer.FakeTypeName})
precompile(Tuple{typeof(Base.delete!), Base.Set{Any}, SymbolServer.FakeTypeName})
precompile(Tuple{typeof(Base.vectorfilter), Type, Base.var"#132#133"{typeof(Base.in), typeof(Base.pop!), Base.Set{Any}}, Array{Any, 1}})
precompile(Tuple{typeof(Base.collect), Type{Any}, Base.Generator{Base.Iterators.Filter{Base.var"#134#135"{Base.var"#132#133"{typeof(Base.in), typeof(Base.pop!), Base.Set{Any}}}, Array{Any, 1}}, typeof(Base.identity)}})
precompile(Tuple{Base.var"#134#135"{Base.var"#132#133"{typeof(Base.in), typeof(Base.pop!), Base.Set{Any}}}, SymbolServer.FakeTypeName})
...
precompile(Tuple{typeof(Base.:(==)), StaticLint.Binding, StaticLint.Binding})
precompile(Tuple{typeof(Base.:(==)), SymbolServer.DataTypeStore, StaticLint.Binding})
precompile(Tuple{typeof(StaticLint.get_method), StaticLint.Binding})
...
precompile(Tuple{typeof(StaticLint.resolve_import_block), CSTParser.EXPR, StaticLint.Toplevel{LanguageServer.Document}, StaticLint.Binding, Bool})
precompile(Tuple{typeof(StaticLint._get_field), StaticLint.Binding, CSTParser.EXPR, StaticLint.Toplevel{LanguageServer.Document}})
precompile(Tuple{typeof(StaticLint.CoreTypes.ismodule), SymbolServer.DataTypeStore})
...
precompile(Tuple{typeof(Base.:(==)), SymbolServer.FakeTypeofVararg, SymbolServer.FakeUnionAll})
precompile(Tuple{typeof(Base.:(==)), SymbolServer.FakeTypeName, SymbolServer.FakeTypeVar})
precompile(Tuple{typeof(Base.:(==)), SymbolServer.FakeTypeofVararg, SymbolServer.FakeUnion})
...
precompile(Tuple{typeof(Base.isequal), SymbolServer.FakeUnionAll, SymbolServer.FakeTypeofVararg})
precompile(Tuple{typeof(Base.push!), Base.Set{Any}, SymbolServer.FakeUnion})
precompile(Tuple{typeof(Base.isequal), SymbolServer.FakeTypeName, SymbolServer.FakeUnion})
precompile(Tuple{typeof(Base.isequal), SymbolServer.FakeTypeName, SymbolServer.FakeTypeName})
precompile(Tuple{Base.var"#97#98"{Base.Fix2{typeof(Base.in), Base.Set{Any}}}, SymbolServer.FakeTypeofVararg})
precompile(Tuple{typeof(Base.isequal), SymbolServer.FakeTypeofVararg, SymbolServer.FakeTypeName})
precompile(Tuple{typeof(Base.delete!), Base.Set{Any}, SymbolServer.FakeTypeofVararg})
precompile(Tuple{Base.var"#97#98"{Base.Fix2{typeof(Base.in), Base.Set{Any}}}, SymbolServer.FakeUnionAll})
precompile(Tuple{typeof(Base.delete!), Base.Set{Any}, SymbolServer.FakeUnionAll})
precompile(Tuple{Base.var"#134#135"{Base.var"#132#133"{typeof(Base.in), typeof(Base.pop!), Base.Set{Any}}}, SymbolServer.FakeTypeofVararg})
precompile(Tuple{Base.var"#134#135"{Base.var"#132#133"{typeof(Base.in), typeof(Base.pop!), Base.Set{Any}}}, SymbolServer.FakeUnionAll})
...
precompile(Tuple{typeof(StaticLint.overwrites_imported_function), Nothing})
...
precompile(Tuple{typeof(StaticLint._mark_import_arg), CSTParser.EXPR, SymbolServer.DataTypeStore, StaticLint.Toplevel{LanguageServer.Document}, Bool})
precompile(Tuple{typeof(CSTParser.longest_common_prefix), String, String})
precompile(Tuple{typeof(StaticLint.get_method), SymbolServer.FunctionStore})
precompile(Tuple{typeof(StaticLint.is_const), SymbolServer.ModuleStore})
precompile(Tuple{typeof(JSONRPC.get_param_type), JSONRPC.NotificationType{LanguageServer.DidSaveTextDocumentParams}})
...
precompile(Tuple{LanguageServer.var"#98#99"{typeof(LanguageServer.textDocument_didSave_notification), LanguageServer.LanguageServerInstance}, JSONRPC.JSONRPCEndpoint{Base.PipeEndpoint, Base.PipeEndpoint}, LanguageServer.DidSaveTextDocumentParams})
...
precompile(Tuple{Base.var"#printstyled##kw", NamedTuple{(:bold, :color), Tuple{Bool, Symbol}}, typeof(Base.printstyled), Base.PipeEndpoint, String})
...
precompile(Tuple{Type{NamedTuple{(:exception, :backtrace), T} where T<:Tuple}, Tuple{Base.IOError, Array{Union{Ptr{Nothing}, Base.InterpreterIP}, 1}}})
