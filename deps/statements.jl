...
precompile(Tuple{Type{LanguageServer.Diagnostic}, LanguageServer.Range, Int64, Base.Missing, Base.Missing, String, String, Base.Missing, Base.Missing})
...
precompile(Tuple{typeof(Base.Broadcast.restart_copyto_nonleaf!), Array{Any, 1}, Array{Expr, 1}, Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Tuple{Base.OneTo{Int64}}, typeof(CSTParser.to_codeobject), Tuple{Base.Broadcast.Extruded{Array{CSTParser.EXPR, 1}, Tuple{Bool}, Tuple{Int64}}}}, Int64, Int64, Base.OneTo{Int64}, Int64, Int64})
