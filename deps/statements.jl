...
precompile(Tuple{typeof(JuliaCLI.test)})
precompile(Tuple{typeof(Base.haskey), NamedTuple{(:allow_autoprecomp,), Tuple{Bool}}, Symbol})
precompile(Tuple{Pkg.API.var"##test#89", Base.TTY, Base.Pairs{Symbol, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Pkg.API.test), Array{Pkg.Types.PackageSpec, 1}})
precompile(Tuple{Pkg.API.var"#test##kw", NamedTuple{(:io,), Tuple{Base.TTY}}, typeof(Pkg.API.test), Pkg.Types.Context, Array{Pkg.Types.PackageSpec, 1}})
precompile(Tuple{typeof(Base.convert), Type{Union{Nothing, Pkg.Types.UpgradeLevel, Base.VersionNumber, String, Pkg.Versions.VersionSpec}}, Base.VersionNumber})
precompile(Tuple{Type{NamedTuple{(:preferences, :force_latest_compatible_version, :allow_earlier_backwards_compatible_versions, :allow_reresolve), T} where T<:Tuple}, Tuple{Base.Dict{String, Any}, Bool, Bool, Bool}})
precompile(Tuple{Pkg.Operations.var"#sandbox##kw", NamedTuple{(:preferences, :force_latest_compatible_version, :allow_earlier_backwards_compatible_versions, :allow_reresolve), Tuple{Base.Dict{String, Any}, Bool, Bool, Bool}}, typeof(Pkg.Operations.sandbox), Function, Pkg.Types.Context, Pkg.Types.PackageSpec, String, String, Pkg.Types.Project})
precompile(Tuple{Base.Filesystem.var"##mktempdir#24", String, typeof(Base.Filesystem.mktempdir), Pkg.Operations.var"#105#110"{Base.Dict{String, Any}, Bool, Bool, Bool, Pkg.Operations.var"#120#125"{Bool, Base.Cmd, Base.Cmd, Nothing, Pkg.Types.Context, Array{Tuple{String, Base.Process}, 1}, String, Pkg.Types.PackageSpec}, Pkg.Types.Context, Pkg.Types.PackageSpec, String, Pkg.Types.Project, String}, String})
precompile(Tuple{Type{NamedTuple{(:name, :path, :deps), T} where T<:Tuple}, Tuple{String, String, Base.Dict{String, Base.UUID}}})
precompile(Tuple{Core.var"#Type##kw", NamedTuple{(:name, :path, :deps), Tuple{String, String, Base.Dict{String, Base.UUID}}}, Type{Pkg.Types.PackageEntry}})
...
precompile(Tuple{Type{NamedTuple{(:io, :hidden_upgrades_info), T} where T<:Tuple}, Tuple{Base.DevNull, Bool}})
precompile(Tuple{Pkg.Operations.var"#show_update##kw", NamedTuple{(:io, :hidden_upgrades_info), Tuple{Base.DevNull, Bool}}, typeof(Pkg.Operations.show_update), Pkg.Types.EnvCache, Array{Pkg.Registry.RegistryInstance, 1}})
precompile(Tuple{Core.var"#Type##kw", NamedTuple{(:io,), Tuple{Base.TTY}}, Type{Pkg.Types.Context}})
precompile(Tuple{Type{NamedTuple{(:mode, :io, :ignore_indent, :show_usagetips), T} where T<:Tuple}, Tuple{Pkg.Types.PackageMode, Base.TTY, Bool, Bool}})
precompile(Tuple{Pkg.Operations.var"#status##kw", NamedTuple{(:mode, :io, :ignore_indent, :show_usagetips), Tuple{Pkg.Types.PackageMode, Base.TTY, Bool, Bool}}, typeof(Pkg.Operations.status), Pkg.Types.EnvCache, Array{Pkg.Registry.RegistryInstance, 1}})
precompile(Tuple{Type{NamedTuple{(:uuid, :name, :path, :repo, :pinned, :tree_hash, :version), T} where T<:Tuple}, Tuple{Base.UUID, String, String, Pkg.Types.GitRepo, Bool, Nothing, Pkg.Versions.VersionSpec}})
precompile(Tuple{Core.var"#Type##kw", NamedTuple{(:uuid, :name, :path, :repo, :pinned, :tree_hash, :version), Tuple{Base.UUID, String, String, Pkg.Types.GitRepo, Bool, Nothing, Pkg.Versions.VersionSpec}}, Type{Pkg.Types.PackageSpec}})
precompile(Tuple{Type{NamedTuple{(:uuid, :name, :path, :pinned, :repo, :tree_hash, :version), T} where T<:Tuple}, Tuple{Base.UUID, String, String, Bool, Pkg.Types.GitRepo, Nothing, Pkg.Versions.VersionSpec}})
precompile(Tuple{Core.var"#Type##kw", NamedTuple{(:uuid, :name, :path, :pinned, :repo, :tree_hash, :version), Tuple{Base.UUID, String, String, Bool, Pkg.Types.GitRepo, Nothing, Pkg.Versions.VersionSpec}}, Type{Pkg.Types.PackageSpec}})
...
precompile(Tuple{typeof(JuliaCLI.test), String})
...
precompile(Tuple{SymbolServer.var"#61#64"{String, Base.Dict{Base.UUID, Pkg.Types.PackageEntry}, Pair{Base.UUID, Pkg.Types.PackageEntry}, SymbolServer.SymbolServerInstance, String}})
...
precompile(Tuple{Type{NamedTuple{(:exception,), T} where T<:Tuple}, Tuple{Downloads.RequestError}})
precompile(Tuple{Base.CoreLogging.var"#handle_message##kw", NamedTuple{(:exception,), Tuple{Downloads.RequestError}}, typeof(Base.CoreLogging.handle_message), Logging.ConsoleLogger, Base.CoreLogging.LogLevel, String, Module, Symbol, Symbol, String, Int64})
precompile(Tuple{typeof(Base.iterate), Base.Pairs{Symbol, Downloads.RequestError, Tuple{Symbol}, NamedTuple{(:exception,), Tuple{Downloads.RequestError}}}})
precompile(Tuple{typeof(Logging.showvalue), Base.IOContext{Base.GenericIOBuffer{Array{UInt8, 1}}}, Downloads.RequestError})
precompile(Tuple{typeof(Base.iterate), Base.Pairs{Symbol, Downloads.RequestError, Tuple{Symbol}, NamedTuple{(:exception,), Tuple{Downloads.RequestError}}}, Int64})
